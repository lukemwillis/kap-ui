  ...
  return (
    <Flex direction="column" width="100%" gap={{ base: "4", md: "8" }}>
      ...
      <Text fontSize={{ base: "md", md: "xl" }}>
        KAP makes it easy to access dApps without buying tokens. You just get a
        free or premium username and go. Built on the Koinos blockchain, KAP is
        the backbone of social, gaming, and any other free-to-use dApp. KAP is
        launching in Q2 2023 with premium account names. It will evolve to
        ...
        <Accordion>
          <AccordionItem borderWidth="0">
            ...
            <AccordionPanel>
              ...
              have 10 or fewer characters and will be priced based on character
              count.
            </AccordionPanel>
          </AccordionItem>
          <AccordionItem borderWidth="0">
